...
from anyzork.engine.combat import CombatMixin
from anyzork.engine.dialogue_mixin import DialogueMixin
from anyzork.engine.narrator_mixin import NarratorMixin
from anyzork.engine.npc_behaviors import NPCBehaviorMixin
from anyzork.engine.quests import QuestMixin
from anyzork.engine.triggers import TriggerMixin
...
class GameEngine(
    ...
    Delegates to focused subsystem mixins:
    - DialogueMixin — NPC conversations
    - TriggerMixin — event emission and trigger evaluation
    - QuestMixin — quest state machine and quest log
    - CombatMixin — attack resolution and combat rounds
    - NarratorMixin — optional LLM prose narration
    - NPCBehaviorMixin — NPC autonomous actions
    """
