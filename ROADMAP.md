...
This roadmap orders open work by leverage and dependency. Each item links to a GitHub issue with full details.

## 1. Harden the Core Loop

Stabilize the shipped `generate -> import -> play` pipeline before adding features.

- [#8 Atomic command execution or narrowed docs](https://github.com/oobagi/anyzork/issues/8)
