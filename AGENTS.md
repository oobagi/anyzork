...
- **LLM Providers**: Codex API, OpenAI API, Gemini API (bring your own key)
- **Config**: pydantic-settings (env vars with `ANYZORK_` prefix)

## Agents

Specialized agents in `.Codex/agents/` (sourced from [agency-agents](https://github.com/msitarzewski/agency-agents)):

| Agent | File | Role |
|-------|------|------|
| Game Designer | `.Codex/agents/game-designer.md` | Systems/mechanics, GDD, gameplay loops |
| Narrative Designer | `.Codex/agents/narrative-designer.md` | Story, lore, dialogue, world-building |
| Level Designer | `.Codex/agents/level-designer.md` | Room layout, spatial flow, pacing |
| Software Architect | `.Codex/agents/engineering-software-architect.md` | System design, ADRs |
| Code Reviewer | `.Codex/agents/engineering-code-reviewer.md` | Code quality, security |
| Reality Checker | `.Codex/agents/testing-reality-checker.md` | Validation, production readiness |
| Technical Artist | `.Codex/agents/technical-artist.md` | Visual/technical polish |
| Game Audio Engineer | `.Codex/agents/game-audio-engineer.md` | Audio design |
...
- **Configurable providers** — bring your own API key (Codex, OpenAI, or Gemini)
